...
export interface paths {
    ...
    "/corpora/{corpus_id}/chunk-set-name-availability": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/corpus-bm25-build-jobs/name-availability": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
...
export interface components {
    schemas: {
        ...
        CorpusBm25BuildJobRead: {
            ...
            /** Corpus Chunk Set Checksum */
            corpus_chunk_set_checksum: string;
            /** Corpus Chunk Set Id */
            corpus_chunk_set_id: number | null;
            /** Corpus Chunk Set Revision */
            corpus_chunk_set_revision: number;
            /** Corpus Id */
            corpus_id: number;
        ...
        FullCorpusIndexPipeJobCreate: {
            ...
            /** Embedding Model */
            embedding_model: string;
            /** Requested Bm25 Index Name */
            requested_bm25_index_name?: string | null;
            /** Requested Chunk Set Name */
            requested_chunk_set_name: string;
         ...
         * @description Simulation retrieval compatible pair for building a hybrid RAG index.
         */
        SimulationRetrievalCompatiblePair: {
            /** Bm25 Index Id */
...
export interface operations {
    ...
    get_corpus_chunk_set_name_availability_corpora__corpus_id__chunk_set_name_availability_get: {
        parameters: {
            query: {
                name: string;
            };
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["CorpusChunkSetNameAvailability"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    list_corpus_chunk_sets_corpora__corpus_id__chunk_sets_get: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["CorpusChunkSetRead"][];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    get_corpus_bm25_index_name_availability_corpus_bm25_build_jobs_name_availability_get: {
        parameters: {
            query: {
                name: string;
            };
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["CorpusBm25IndexNameAvailability"];
                };
            };
            /** @description Validation Error */
            422: {
