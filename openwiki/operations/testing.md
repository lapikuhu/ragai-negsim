...
- `tests/unit/test_compose_policy_boundary.py` covers the boundary between locked backend policy constants and compose/example environment files, keeping compose/env configuration out of the fixed backend policy contract.
