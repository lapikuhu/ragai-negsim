...
- `UserDetailPage.tsx` is the admin-facing, role-aware user activity view. Students show simulation participation; teachers add evaluations and authored scenarios, corpora, and personas; admins also show authored RAG profiles and users they created.
